...
<table class="table table-striped table-hover">
    ...
    $category_result = connect::executer("SELECT * FROM `model` LIMIT 3 OFFSET ".$pro_view_offset.";");
...
?>
    ...
    <div class="col-12 mb-3 d-flex justify-content-center">
        ...
        <div class="pagination  mt-2">
            ...
            if ($pro_view_page != 1) {
            ?>
                <button onclick="paginate_model(<?php echo  $pro_view_page - 1; ?>);" class="ms-1">&laquo;</button>
            ...
            if ($pro_view_page != $product_full_amount) {
                ...
                <button onclick="paginate_model(<?php echo  (int)$pro_view_page + 1; ?>);" class="ms-1">&raquo;</button>
